...
public class PromocionesActivity extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.navPedidos:
                intent = new Intent(PromocionesActivity.this, MisPedidosActivity.class);
                startActivity(intent);
                finish();
                break;
            case R.id.navPerfil:
                intent = new Intent(PromocionesActivity.this, MiPerfilActivity.class);
                startActivity(intent);
                finish();
                break;
